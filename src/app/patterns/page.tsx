...
export default function PatternsPage() {
  const items = getAllContent(['pattern']);
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem 1.5rem' }}>
      ...
      <h1 style={{ marginBottom: '0.5rem' }}>Patterns</h1>
      ...
      {items.length === 0 ? (
        <p style={{ color: 'var(--text-tertiary)' }}>No patterns yet. Add .md files to content/patterns/</p>
      ) : (
