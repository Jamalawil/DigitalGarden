...
export const metadata: Metadata = { title: 'Antilibrary' };

export default function AntilibraryPage() {
  const books = getAllContent(['antilibrary']);
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem 1.5rem' }}>
      ...
      <h1 style={{ marginBottom: '0.5rem' }}>Antilibrary</h1>
      <p style={{ color: 'var(--text-secondary)', marginBottom: '2.5rem', fontSize: '1.1rem', maxWidth: '60ch' }}>
        Books I like the idea of having read — the unread shelf is the most important one.
      </p>
      {books.length === 0 ? (
        <p style={{ color: 'var(--text-tertiary)' }}>No books yet. Add .md files to content/antilibrary/</p>
      ) : (
